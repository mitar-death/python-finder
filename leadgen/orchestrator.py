...
class LeadOrchestrator:
    ...
    def run_provider_search(self):
        ...
        logger.success(
            f"Search phase complete: {len(self.companies)} companies, {len(self.domains)} unique domains"
        )
